...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.13.1/css/bootstrap-select.css" />
             ...
             <div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    <h3 class="text-themecolor mb-0">Events List</h3>
                                      ...
                                      <table id="file_export" class="table table-striped table-bordered display">
                                        ...
                                        <?php  $i = 0;
                                            ...
                                            <tr>
                                              ...
                                              <td><?php echo date("d-m-Y h:i:s a",strtotime($events->created_date));?></td>

                                              <td>
                                                <a href="#" name="delete"  value="<?php echo $events->id ?>" id="<?php echo $events->id ?>"  onclick="archiveFunction(this.id)" data-toggle="tooltip" title="Remove"><i class="ti-trash"></i></a>
                                              </td>
                                            </tr>
                                            <?php }   ?>
                                        </tbody>
    ...
    function archiveFunction(id) {
        ...
        if (result.value) {
            ...
            $.ajax({
                method: 'POST',
                data: {'id' : id },
                url: '<?php echo base_url() ?>admin/settings/events/'+id,
