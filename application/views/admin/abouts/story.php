...
<div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
        <h3 class="text-themecolor mb-0 text-success">Events </h3>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">    
                            <div class="form-group mb-5">
                                <input type="text" class="form-control" name="event" id="input3" required>
                                <span class="bar"></span>
                        ...
                        <div class="col-md-3">    
                            <div class="form-group mb-5">
                                <input type="text" class="form-control" name="delegate" id="input3" required>
                                <span class="bar"></span>
                        ...
                        <div class="col-md-3">    
                            <div class="form-group mb-5">
                                <input type="text" class="form-control" name="date" id="input3" required>
                                <span class="bar"></span>
                        ...
                        <div class="col-md-3">    
                            <div class="form-group mb-5">
                                <input type="text" class="form-control" name="time" id="input3" required>
                                <span class="bar"></span>
                   ...
                   <div class="table-responsive">
                        <table id="file_export" class="table table-striped table-bordered display">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo ++$i ?></td>
                                    <td> <?php if($st->image){ ?><img class="thumbnail" style="height: 80px; width: 120px;" src="<?php echo base_url(); ?><?php echo $st->image ?>" alt=""><?php } ?></td>
                                    <td><?php echo $st->text ?></td>
                                    <td><?php echo $st->event ?></td>
                                    <td><?php echo $st->delegate ?></td>
                                    <td>
