                          ...
                          <div class="card">
                              <div class="card-body">
                                  <div class="table-responsive">
                                      ...
                                      <input type="submit" class="btn btn-danger btn-sm float-right" name="bulk_delete_submit1" value="Delete" style="margin-left: 10px; ">
                                        ...
                                        <?php  $i = 0;
                                            ...
                                            <tr>
                                              <td><?php echo ++$i ?></td>
                                              <td><?php echo $solu->name ?></td>
                                              <td><?php echo $solu->email ?></td>
                                              <td><?php echo $solu->phone ?></td>
                                              <td><?php echo date("d-m-Y h:i:s a",strtotime($solu->date));?></td>
                                              <td><?php echo date(" h:i:s a",strtotime($solu->time)) ?></td>
    ...
    function archiveFunction(id) {
        ...
        if (result.value) {
            ...
            $.ajax({
                method: 'POST',
                data: {'id' : id },
                url: '<?php echo base_url() ?>admin/settings/del_booking/'+id,
