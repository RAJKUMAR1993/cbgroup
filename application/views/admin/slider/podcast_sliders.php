                                ...
                                <form class="floating-labels mt-4" action="<?php echo base_url() ?>admin/podcast/add" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                     <div class="col-md-3 ">
                                        ...
                                        <div class="col-md-8 "  id="short_desc">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="file_export" class="table table-striped table-bordered display">
                                        ...
                                        <tr>
                                            <td><?php echo ++$i ?></td>
                                            <td> <?php if($s->image){ ?><img class="thumbnail" style="height: 80px; width: 120px;" src="<?php echo base_url(); ?><?php echo $s->image ?>" alt=""><?php } ?></td>
                                            <td><?php echo $s->	short_desc ?></td>
                                            <td>
