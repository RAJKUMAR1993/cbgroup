...
class About extends MY_Controller {
    ...
    public function update(){
        ...
        if($s){
            $this->session->set_flashdata("msg"," Successfully Updated","smsg");
            redirect("admin/about");
        }else{
            $this->session->set_flashdata("msg","Error Occured While Updating ","emsg");
            redirect("admin/about");
        }
    ...
    public function status(){
		...
		if($d){
			if($status=="Active"){
				$this->session->set_flashdata("msg",'Successfully  Enabled');
				//echo $this->alert->pnotify("Success","Successfully Navbar Sub Menu Enabled","success");
			}else{
				$this->session->set_flashdata("msg",'Successfully  Disabled');
			...
			if($status=="Active"){
				...
				$this->session->set_flashdata("msg",'Error Occured While Enabling');
				//echo $this->alert->pnotify("Error","Error Occured While Enabling Navbar Sub Menu","error");
			}else{
				$this->session->set_flashdata("msg",'Error Occured While Disabling');
	...
	public function story_update(){
        ...
        if($s){
            ...
            $this->session->set_flashdata("error","Error Occured While Updating ","emsg");
            redirect("admin/about/story");
        }
	}
	public function story_status(){
		...
		if($d){
			...
			if($status=="Active"){
				$this->session->set_flashdata("error",'Error Occured While Enabling');
			}else{
				$this->session->set_flashdata("error",'Error Occured While Disabling');
